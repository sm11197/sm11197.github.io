...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{efc}\SpecialCharTok{$}\NormalTok{weight }\OtherTok{\textless{}{-}} \FunctionTok{abs}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(efc), }\DecValTok{1}\NormalTok{, .}\DecValTok{3}\NormalTok{))}
\FunctionTok{weighted\_mannwhitney}\NormalTok{(c12hour }\SpecialCharTok{\textasciitilde{}}\NormalTok{ c161sex }\SpecialCharTok{+}\NormalTok{ weight, efc)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wilcox.test}\NormalTok{(efc}\SpecialCharTok{$}\NormalTok{c12hour,efc}\SpecialCharTok{$}\NormalTok{c161sex)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{judgments\_online}\SpecialCharTok{$}\NormalTok{fpcw }\OtherTok{\textless{}{-}}\NormalTok{ judgments\_online}\SpecialCharTok{$}\NormalTok{fpc }\SpecialCharTok{*}\NormalTok{judgments\_online}\SpecialCharTok{$}\NormalTok{sampled\_consultancies\_all\_debates\_weights\_grouped\_setting}
\FunctionTok{wilcox.test}\NormalTok{(fpcw}\SpecialCharTok{\textasciitilde{}}\NormalTok{Final\_Setting, }\FunctionTok{subset}\NormalTok{(judgments\_online, }\StringTok{\textasciigrave{}}\AttributeTok{Human Consultancy Sample}\StringTok{\textasciigrave{}} \SpecialCharTok{==} \ConstantTok{TRUE} \SpecialCharTok{|} \SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"Consultancy"}\NormalTok{, Final\_Setting) }\SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"AI"}\NormalTok{, Final\_Setting)), }\AttributeTok{conf.int=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
