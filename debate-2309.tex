...
\NormalTok{  svy\_table }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\StringTok{"n Judgments (weighted)"} \OtherTok{=}\NormalTok{ (svy\_table[,}\StringTok{"FALSE"}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ svy\_table[,}\StringTok{"TRUE"}\NormalTok{]), svy\_table)}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2277}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0891}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2277}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2178}}
...
\NormalTok{generate\_bins }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(start, end, step) \{}
\NormalTok{  breaks }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(start, end }\SpecialCharTok{+} \DecValTok{1}\NormalTok{, }\AttributeTok{by =}\NormalTok{ step)  }\CommentTok{\# Extend the sequence to end + 1 to include the end point}
\NormalTok{  labels }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{length}\NormalTok{(breaks) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{), }\ControlFlowTok{function}\NormalTok{(i) \{}
\NormalTok{    lower\_bound }\OtherTok{=}\NormalTok{ breaks[i]}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{    upper\_bound }\OtherTok{=}\NormalTok{ breaks[i}\SpecialCharTok{+}\DecValTok{1}\NormalTok{]}
    \FunctionTok{return}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(lower\_bound, }\StringTok{"{-}"}\NormalTok{, upper\_bound))  }\CommentTok{\# Return the range string}
\NormalTok{  \})}
\NormalTok{  breaks }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\ConstantTok{Inf}\NormalTok{, breaks, }\ConstantTok{Inf}\NormalTok{)  }\CommentTok{\# Extend the breaks vector to include Inf}
\NormalTok{  labels }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"0"}\NormalTok{, labels, }\FunctionTok{paste0}\NormalTok{(end}\SpecialCharTok{+}\DecValTok{1}\NormalTok{,}\StringTok{"+"}\NormalTok{))}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\AttributeTok{breaks =}\NormalTok{ breaks, }\AttributeTok{labels =}\NormalTok{ labels))}
\NormalTok{\}}

\CommentTok{\# Now use this function to generate the breaks and labels:}
\NormalTok{bins }\OtherTok{\textless{}{-}} \FunctionTok{generate\_bins}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{15}\NormalTok{, }\DecValTok{3}\NormalTok{)}

\CommentTok{\# Now use these dynamically generated values in your mutate function:}
\NormalTok{strat }\OtherTok{\textless{}{-}}\NormalTok{ strat }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{cut}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds by room}\StringTok{\textasciigrave{}}\NormalTok{,}
                                       \AttributeTok{breaks =}\NormalTok{ bins}\SpecialCharTok{$}\NormalTok{breaks,}
                                       \AttributeTok{labels =}\NormalTok{ bins}\SpecialCharTok{$}\NormalTok{labels,}
                                       \AttributeTok{right =} \ConstantTok{TRUE}\NormalTok{,}
                                       \AttributeTok{include.lowest =} \ConstantTok{TRUE}\NormalTok{))}
\NormalTok{strat }\OtherTok{\textless{}{-}}\NormalTok{ strat }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{cut}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds by room}\StringTok{\textasciigrave{}}\NormalTok{, }
                                       \AttributeTok{breaks =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\ConstantTok{Inf}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{12}\NormalTok{, }\DecValTok{15}\NormalTok{, }\ConstantTok{Inf}\NormalTok{),}
                                       \AttributeTok{labels =} \FunctionTok{c}\NormalTok{(}\StringTok{"0"}\NormalTok{, }\StringTok{"1{-}3"}\NormalTok{, }\StringTok{"4{-}6"}\NormalTok{, }\StringTok{"7{-}9"}\NormalTok{, }\StringTok{"10{-}12"}\NormalTok{, }\StringTok{"13{-}15"}\NormalTok{, }\StringTok{"16+"}\NormalTok{),}
                                       \AttributeTok{right =} \ConstantTok{TRUE}\NormalTok{, }
                                       \AttributeTok{include.lowest =} \ConstantTok{TRUE}\NormalTok{))}
...
\CommentTok{\# deprecated, keep original max round except if above cutoff}
\NormalTok{strat }\OtherTok{\textless{}{-}}\NormalTok{ strat }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{ifelse}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds by room}\StringTok{\textasciigrave{}} \SpecialCharTok{\textgreater{}} \DecValTok{5}\NormalTok{, }\StringTok{"6+"}\NormalTok{, }\FunctionTok{as.character}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds by room}\StringTok{\textasciigrave{}}\NormalTok{))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{factor}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}}\NormalTok{, }
                                        \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"0"}\NormalTok{, }\StringTok{"1"}\NormalTok{, }\StringTok{"2"}\NormalTok{, }\StringTok{"3"}\NormalTok{, }\StringTok{"4"}\NormalTok{, }\StringTok{"5"}\NormalTok{),}
                                         \AttributeTok{ordered =} \ConstantTok{TRUE}\NormalTok{))}

\CommentTok{\# Extract unique bin values}
\NormalTok{unique\_bins }\OtherTok{\textless{}{-}} \FunctionTok{levels}\NormalTok{(strat}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}}\NormalTok{)[}\DecValTok{2}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(}\FunctionTok{levels}\NormalTok{(strat}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}}\NormalTok{))]}
...
\NormalTok{strat }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}} \SpecialCharTok{!=} \StringTok{"0"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# Remove entries with "0" bin}
  \FunctionTok{group\_by}\NormalTok{(Final\_Setting, }\StringTok{\textasciigrave{}}\AttributeTok{Num previous judging rounds}\StringTok{\textasciigrave{}}\NormalTok{, }\StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{  \}) }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ lower\_ci, }\AttributeTok{ymax =}\NormalTok{ upper\_ci, }\AttributeTok{fill =} \StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{group =} \StringTok{\textasciigrave{}}\AttributeTok{Max judge rounds bin}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{color =} \ConstantTok{NULL}\NormalTok{), }\AttributeTok{alpha =} \FloatTok{0.25}\NormalTok{) }\SpecialCharTok{+}
